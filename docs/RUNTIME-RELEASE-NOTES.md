# CIA RENDER runtime release notes
...
| `bootstrap-rife.ps1` | `src-tauri/resources/bootstrap/` | Optional RIFE setup | Reviewed source; it installs only below CIA RENDER's per-user app-data directory. |
...
The optional INTERPOLATION setup installs Python into CIA RENDER app data,
